...
public class UpdateVideoControl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		video = dao_Video.getByID(Integer.parseInt(videoID));
		...
		video = new Video(Integer.parseInt(videoID), nameVideo, description, performer, createDate, image, video1, time, 0, 0, 0, category, account);
	
		dao_Video.update(video);
