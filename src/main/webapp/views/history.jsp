	...
	<div class="container">
		...
		<div class="wrapper">
			...
			<div class="main-container" style="margin-top: 70px; height: 100vh">
				<div class="small-header anim" style="-delay: .3s">Video đã
					xem</div>
				<h1 style="-delay: .4s">${mss}</h1>
				<div id="videos">
					<c:forEach items="${historys}" var="o" varStatus="status">
						<div class="video anim" style="-delay: .4s">
							<a
								href="watch?video=${o.video.videoID}&cid=${o.video.category.categoryID}">
								...
								<div class="video-wrapper">
									...
									<div class="author-img__wrapper video-author">
										...
										<img class="author-img" src="${o.author.avartar}" />
									</div>
								</div>
								<div class="video-by">${o.author.fullname }</div>
