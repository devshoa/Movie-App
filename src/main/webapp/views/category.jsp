	...
	<div class="container">
		...
		<div class="wrapper">
			...
			<div class="main-container" style="margin-top: 70px; height: 100vh;">
				<div class="small-header anim" style="-delay: .3s">Thể loại</div>
				<div id="videos">

					<c:forEach items="${videos}" var="o" varStatus="status">
								...
								<div class="message-container">
									...
									<div class="message anim" style="-delay: .2s">
										...
										<div class="msg-wrapper">
											...
											<div class="msg__content video-p-sub">Suscipit eos
												atque voluptates labore</div>
										</div>
									</div>
