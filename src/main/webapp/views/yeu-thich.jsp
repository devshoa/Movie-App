...
<body>
	<div class="container">
		...
		<div class="wrapper">
			...
			<div class="main-container" style="margin-top: 70px; height: 100vh">

				<c:if test="${search == null}">
					<div class="small-header anim" style="-delay: .3s">Video yêu
						thích</div>
				</c:if>
				
				<div class="small-header anim" style="-delay: .3s">${mss}</div>


				<br>

				<c:if test="${search != null}">
					<div class="small-header anim" style="-delay: .3s">${search}</div>
				</c:if>
				...
				<div id="videos">
					...
					<c:forEach items="${listVideos}" var="o" varStatus="status">
						<div class="video anim" style="-delay: .4s">
							<a href="watch?video=${o.video.videoID}&cid=${o.video.category.categoryID}">
								<div class="video-time">${o.video.time}</div>
								<div class="video-wrapper">
									<img class="image"
										style="position: absolute; width: 100%; height: 100%;" alt=""
										src="${o.video.images }">
									<video muted="${o.video.links}">
										<source src="${o.video.links}" type="video/mp4">
									</video>
								...
								<div class="video-name">${o.video.nameVideo}</div>
								<div class="video-view">${o.video.views}
							...
							<div class="message-container">
								...
								<div class="message anim" style="-delay: .4s">
									<div class="author-img__wrapper video-author video-p">
										...
										<img class="author-img"
											src="https://yt3.ggpht.com/n1XlPmibI3WS7dmJcjZjJfWttPKLeuid2B9xI-tehW0IYFChu_BbLDmYk26Ss3eqllgEA7wgoQ=s88-c-k-c0x00ffffff-no-rj-mo" />
									</div>
									<div class="msg-wrapper">
	...
	<script type="text/javascript">
		function searchByName(param) {
			...
			$.ajax({
				url : "/Fpoly/searchAjax",
				type : "get", //send it through get method
				// đẩy data qua bên servlet
				data : {
					txt : textSearch
				},
				success : function(data) {
					//Do Something
					var row = document.getElementById("videos");
					row.innerHTML = data;
				},
				error : function(xhr) {
